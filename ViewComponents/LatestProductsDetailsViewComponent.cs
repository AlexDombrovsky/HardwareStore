...
{
    public class LatestProductsDetailsViewComponent : ViewComponent
    {
        private const int LatestProductsCount = 4;
        private readonly IMapper _mapper;
        private readonly IProductService _productService;

        public LatestProductsDetailsViewComponent(IProductService productService, IMapper mapper)
        {
